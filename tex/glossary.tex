...
\newglossaryentry{encapsulation}{
   name = {encapsulation},
   description = {The technique in which a data unit from one protocol is placed within the data field portion of the data unit of another protocol.}
}
...
\newglossaryentry{link-state routing}{
   name = {link-state routing},
   description = {A routing method in which each router shares its knowledge of changes in its neighbourhood with all other routers.}
}
