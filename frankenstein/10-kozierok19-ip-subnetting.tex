...
\begin{description}
   ...
   \item[Subnet 1]
      ...
      The address becomes
      \begin{quote}
      1010 0110\quad 0111 0001\quad \textbf{0000 1}000\quad 0000 0000
      \end{quote}
...
\begin{quote}
1101 0011\quad 0100 1101\quad 0001 0100\quad \textbf{000}\textit{0 0000}
\end{quote}
...
So it is as follows:
\begin{quote}
1101 0011\quad 0100 1101\quad 0001 0100\quad \textbf{000}\textit{0 0001}
\end{quote}
...
\begin{quote}
1101 0011\quad 0100 1101\quad 0001 0100\quad \textbf{000}\textit{0 0010}
\end{quote}
...
\begin{quote}
1101 0011\quad 0100 1101\quad 0001 0100\quad \textbf{110}\textit{0 0000}
\end{quote}

You assign hosts to this subnet by substituting 00001, then 00010, then 00011 for the host ID bits as shown earlier.
Let's take the hosts one at a time:

The first host address is as follows:
\begin{quote}
1101 0011\quad 0100 1101\quad 0001 0100\quad \textbf{110}\textit{0 0001}
\end{quote}
or 211.77.20.193.

The second host address is
\begin{quote}
1101 0011\quad 0100 1101\quad 0001 0100\quad \textbf{110}\textit{0 0010}
\end{quote}
or 211.77.20.194.

And so on, all the way up to the last host in the subnet, which is 211.77.20.222.
\Cref{fig:class-c-host-addresses} shows graphically how subnet and host addresses are calculated for this sample network.
...
\begin{quote}
1010 0110\quad 0111 0001\quad \textbf{0110 1}\textit{000\quad 0000 0000}
\end{quote}
