...
Tot op een dag bijvoorbeeld switch~2 kapot gaat en alle computers die met switches~3 t.e.m.~5 verbonden zijn, geen Internetconnectiviteit meer hebben.
...
Dit brengt echter een enorm gevaar met zich mee.
Zo lang switch~2 defect blijft, is er niets aan de hand.
Maar zodra switch~2 vervangen wordt door een nieuwe switch, hebben we een lus gecreëerd in het netwerk.
Switch~1 verbindt met switch~2, zo met switch~3 en dan terug naar switch~1.
