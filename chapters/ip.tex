...
\fxwarning{Write a few paragraphs on \IP\ header options.}
...
%[caption={Enable routing on a FreeBSD host},label={lst:freebsd-enable-routing}]
\begin{fltlisting}[h!]
