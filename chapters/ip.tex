...
Let's now take an example where we split the network in the middle of an octet.
...
\begin{sidecaption}%
   ...
   {When using \acfp{VLSM} you can further divide a subnet into smaller segments}%
   [fig:vlsm]
\centering
\begin{tikzpicture}
   \draw[white] (0,-35mm) -- (0,35mm);
