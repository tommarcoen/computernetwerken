...
\paragraph{\gls{LAN}}\index{LAN@\acs{LAN}}
...
\paragraph{\gls{WAN}}\index{WAN@\acs{WAN}}
...
\paragraph{\gls{PAN}}\index{PAN@\acs{PAN}}
...
\paragraph{\gls{CAN}}\index{CAN@\acs{CAN}}
...
\paragraph{\gls{MAN}}\index{MAN@\acs{MAN}}
...
\paragraph{\gls{SAN}}\index{SAN@\acs{SAN}}
...
\paragraph{internet}\index{internet}
...
\paragraph{\gls{DMZ}}\index{DMZ@\acs{DMZ}}
...
\paragraph{mainframe (1970)}\index{mainframe}
...
\paragraph{thicknet (1980)}\index{thicknet}
...
\paragraph{Token Ring (1984)}\index{Token Ring}
...
\paragraph{thinnet (1985)}\index{thinnet}
