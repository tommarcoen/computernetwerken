...
Networks may be characterised by many properties or features, such as physical capacity, organisational scope (\vref{sec:organisational-scope}), user authorisation, access rights, and others.
