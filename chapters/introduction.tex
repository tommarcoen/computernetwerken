...
This course discusses computer networks.
I believe it is safe to presume that all participants have a basic understanding of what a computer is, despite the fact that many devices contain a computer without the user being aware of it.
For example, the \SC{ATM}%
   \footnote{Here \SC{ATM} stands for automated teller machine; in the rest of the manual it stands for \acl{ATM}.}
...
When you connect these computers together using network cables or using wireless network adapters, they can form a network.
